-- =============================================================================
--  New Adventurer Starter Kit — XP / Fast-Leveling (quest-based)
--  TrinityCore 3.3.5  (TDB 25101 world schema)
--
--  Created by Iceymidgit.
--
--  Same Quartermaster (entry 604003), one-time class-locked quest. Reward: 2x Netherweave Bag + heirloom chest + heirloom shoulders (each +10% XP, +20% combined) matched to the class's armor type, plus 3 silver. No weapon. Once per CHARACTER. Shares NPC entry 604003 and quest IDs 60001-60011 with the full-outfit version — import ONE.
-- =============================================================================
...
INSERT INTO `quest_template`
 ...
 VALUES (60001,2,-1,0,0,0,300, 21841,2, 48685,1, 42949,1, 'Warrior Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60002,2,-1,0,0,0,300, 21841,2, 48685,1, 42949,1, 'Paladin Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60003,2,-1,0,0,0,300, 21841,2, 48677,1, 42950,1, 'Hunter Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60004,2,-1,0,0,0,300, 21841,2, 48689,1, 42952,1, 'Rogue Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60005,2,-1,0,0,0,300, 21841,2, 48691,1, 42985,1, 'Priest Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60006,2,-1,0,0,0,300, 21841,2, 48685,1, 42949,1, 'Death Knight Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60007,2,-1,0,0,0,300, 21841,2, 48683,1, 42951,1, 'Shaman Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60008,2,-1,0,0,0,300, 21841,2, 48691,1, 42985,1, 'Mage Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60009,2,-1,0,0,0,300, 21841,2, 48691,1, 42985,1, 'Warlock Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
INSERT INTO `quest_template`
 (`ID`,`QuestType`,`QuestLevel`,`MinLevel`,`AllowableRaces`,`Flags`,`RewardMoney`,
  `RewardItem1`,`RewardAmount1`,`RewardItem2`,`RewardAmount2`,`RewardItem3`,`RewardAmount3`,
  `LogTitle`,`QuestDescription`)
 VALUES (60011,2,-1,0,0,0,300, 21841,2, 48687,1, 42984,1, 'Druid Starter Kit','Welcome, $N! Take these bags and heirloom armor -- they''ll grow with you and speed your journey. A few coins, too. Now go see the world!');
...
-- ---- Link quests + spawn the Quartermaster in each starting zone ----
