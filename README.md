...
- **StygianTheBest** — original AzerothCore-Content pack (most modules here).
- **Rochet2** — original Portal Master / Jukebox concepts.
- **Iceymidgit** — TrinityCore 3.3.5 ports, the starter-kit content, testing.
- Built for use with **trickerer's NPCBots** mod where relevant.
